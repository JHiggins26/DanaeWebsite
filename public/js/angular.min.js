...
"MM","dd"]),"yyyy-MM-dd.js"),"datetime-local":kb("datetimelocal",Ad,Nb(Ad,"yyyy MM dd.js HH mm ss sss".split(" ")),"yyyy-MM-ddTHH:mm:ss.sss"),time:kb("time",Cd,Nb(Cd,["HH","mm","ss","sss"]),"HH:mm:ss.sss"),week:kb("week",kc,function(a,c)\{if(pa(a))return a;if(x(a))\{kc.lastIndex=0;var d=kc.exec(a);if(d)\{var e=+d[1],f=+d[2],g=d=0,h=0,l=0,k=pd(e),f=7*(f-1);c&&(d=c.getHours(),g=c.getMinutes(),h=c.getSeconds(),l=c.getMilliseconds());return new Date(e,0,k.getDate()+f,d,g,h,l)\}\}return NaN\},"yyyy-Www"),month:kb("month",\
